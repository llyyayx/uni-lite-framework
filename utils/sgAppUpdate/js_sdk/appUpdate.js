// #ifdef APP-PLUS 
import componentConfig from "@/utils/sgAppUpdate/js_sdk/componentConfig.js"
const platform = uni.getSystemInfoSync().platform;
// 主颜色
const $mainColor = componentConfig.appUpdateColor ? componentConfig.appUpdateColor : "FF5B78";
// 弹窗图标url
const $iconUrl = componentConfig.appUpdateIcon ? componentConfig.appUpdateIcon : "/utils/sgAppUpdate/static/scaffold/ic_ar.png";
// 获取当前应用的版本号
